...
public class SearchEditAddressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_edit_address);

        address = findViewById(R.id.text_address2);
    ...
    public void init_webView() {
        // WebView 설정
        webView = (WebView) findViewById(R.id.webview_address2);
